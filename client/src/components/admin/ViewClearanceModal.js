				...
				<Modal.Body>
					<Table striped hover borderless>
						<tbody>
							...
							<tr>
								<td>Financial Department officer</td>
								<td>{props.financialdepartmentofficer}</td>
							</tr>
							<tr>
								<td>Head of Department officer</td>
								<td>{props.headofdepartmentofficer}</td>
							</tr>
							<tr>
								<td>Library Officer</td>
								<td>{props.libraryofficer}</td>
							</tr>
						</tbody>
					</Table>
				</Modal.Body>
